...
(1, 'admin', '$2y$10$lwkw/.C26M4pWixkohA5GupHNsXKsr6BMWkdIUSLkDAFXWIWV8aDO'),
(2, 'Ikhwan', '$2y$10$ilvInohlEFuuwBCayBgID.3hKeweGwmjhafyWYNWO5hbj4ybGlWXS');
...
--
ALTER TABLE `pembelian_sepatu`
  MODIFY `Nomor` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
